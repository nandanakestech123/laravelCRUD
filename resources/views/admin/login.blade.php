...
<body>
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-5 p-0">
                        <div class="signUP-admin-left signIn-admin-left position-relative">
                            <div class="signUP-overlay">
                               <!--  <img class="svg signupTop" src="{{asset('svg/signuptop.svg')}}" alt="img"> -->
                                <img class="svg signupBottom" src="{{asset('svg/signupbottom.svg')}}" alt="img">
                            ...
                            <div class="signUP-admin-left__img">
                                <img class="img-fluid svg" src="{{asset('svg/signupIllustration.svg')}}" alt="img">
                        ...
                        <div class="signUp-admin-right signIn-admin-right  p-md-40 p-10">
                            <!-- <div class="signUp-topbar d-flex align-items-center justify-content-md-end justify-content-center mt-md-0 mb-md-0 mt-20 mb-1">
                                <p class="mb-0">
                                    ...
                                    <a href="sign-up" class="color-primary">
                                        Sign up
                                    </a>
                                </p>
                                        ...
                                        <div class="card border-0">
                                            <div class="card-header border-0  pb-md-15 pb-10 pt-md-20 pt-10 ">
                                                <div class="edit-profile__title">
                                                    <h6>Log In As <span class="color-primary">Admin</span></h6>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <form id="loginForm">
                                                    ...
                                                    <div class="edit-profile__body">
                                                        ...
                                                        <div class="form-group mb-15">
                                                            ...
                                                            <div class="position-relative">
                                                                ...
                                                                <div class="fa fa-fw fa-eye-slash text-light fs-16 field-icon toggle-password2" id="show"></div>
                                                            </div>
                                                        </div>
    ...
    <script src="{{asset('')}}customejs\login.js"></script>
    <!-- endinject-->
</body>
</html>